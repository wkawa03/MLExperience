...
export default function SetInputData(props: {
  ...
  const tooltipPreproc = "入力データをより分析し易くし性能向上に繋がるデータに変換すること。当システムでは簡易的な前処理のみ行う。";
  const tooltipNan = "データに何も入力されていない無効な値のこと。主な処置方法は、同じデータの平均値・中央値・最頻値(最も頻出する値)のいずれかを設定するか、欠損値を含む行を削除する。";
